...
class main:
    ...
    def widgets(self):
        ...
        self.logf.configure(background='orange')
        ...
        Button(self.logf,text = ' Login ',background='pink',bd = 2 ,font = ('',13),padx=6,pady=6,command=self.login).grid(row=8,column=0)
        Button(self.logf,text = ' New user ',background='pink',bd = 2 ,font = ('',13),padx=6,pady=6,command=self.cr).grid(row=8,column=1)
        ...
        Button(self.crf,text = 'Create Account',background='red',bd = 2,font = ('',13),padx=6,pady=6,command=self.new_user).grid(row=11,column=0)
        Button(self.crf,text = 'Go to Login',background='red',bd = 2,font = ('',13),padx=6,pady=6,command=self.log).grid(row=11,column=1)
        ...
        Button(self.crff,text = 'Track',background='red',bd = 2,font = ('',13),padx=6,pady=6,command=self.consignment).grid(row=4,column=0)
        ...
        Button(self.consi,text = 'Back',background='red',bd = 2,font = ('',13),padx=6,pady=6,command=self.track1).grid(row=6,column=0)
